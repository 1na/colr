...
##Use 
Use the package with `library(colr)` or use the functions with `colr::funcname` (for example `colr::cgrep`).
...
library(colr)
head(iris)
head(cgrep(iris,"^Petal\\."))  # matches all columns that have  names starting with the string "Petal."
```
